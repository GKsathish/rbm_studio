...
//      </div> */}
//                        <h4 style={{color: "#763b75" ,padding:8,fontSize:20}}>Campaign Approval</h4>
  ...
  return (
    <>
      ...
      <div className="textcontre">
        ...
        <h4 className='reprottitle' >Campaign Approval</h4>   
        ...
        <button onclick="Export()" className="rbtncamp m-1" >Resend</button>
        <button onclick="Export()" className="rbtncamp m-1" >Approve</button>

        <button onclick="Export()" className="rbtncamp m-1" >Reject</button>
